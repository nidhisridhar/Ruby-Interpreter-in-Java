...
void arithmetic()
{
    ...
    {  
        ...
        if(st.matches("^[a-zA-Z_@$]([a-zA-Z0-9_])*"))
        {
          ...
          {
            System.out.println("\n Undeclared variable present OR Variable out of Scope: "+ st);
            fl=1;
            break;
          }
        }
 ...
 //   System.out.println("fl is "+ fl);
   if(fl==1)return;
    ...
    void deffunc()
    {
        ...
        while(s!="end")
        {
            ...
            if(s.matches("^if\\( +.* +\\)"))
            {
             ...
             System.out.println("The string to be evaluated is : " + q);
            ...
            else if(s.matches("^[a-zA-Z_@$]([a-zA-Z0-9_])* += +(([a-zA-Z_@$]([a-zA-Z0-9_])*)|([0-9]*))( +[/+-/*///^] +(([a-zA-Z_@$]([a-zA-Z0-9_])*)|([0-9]*)))*$"))
            {
                ...
                {  
                    ...
                    if(st.matches("^[a-zA-Z_@$]([a-zA-Z0-9_])*"))
                    {
                        if(Lexer.variable.containsKey(st)==false|| Lexer.variable.get(st)==0.0)
                        {
                            System.out.println("\n Undeclared variable OR Variable Out of Scope " + st + " present. \n");
                            fl = 1;
                            break;
    ...
    void checkelse()
    {
       ...
       if(endcheck==0) System.out.println("ERROR else Statement Doesnt Have An End!");
        int i;
       for(i=0;i<scopecount;i++)
       {
